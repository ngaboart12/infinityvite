  ...
  return (
    <div className=' relative  max-h-[150vh] ' >
      <div className='w-full relative flex px-2 sm:px-20 py-10 bg-[#56697A] justify-center' style={{backgroundImage: `url('..assets/image/contactus.png')`,backgroundRepeat:'no-repeat',backgroundSize:'cover'}}>
        ...
        <path d="M223.705 14.8525C223.705 120.81 137.81 206.705 31.8525 206.705C-74.1047 206.705 -160 120.81 -160 14.8525C-160 -91.1047 -74.1047 -177 31.8525 -177C137.81 -177 223.705 -91.1047 223.705 14.8525ZM-73.0785 14.8525C-73.0785 72.8042 -26.0993 119.783 31.8525 119.783C89.8042 119.783 136.783 72.8042 136.783 14.8525C136.783 -43.0993 89.8042 -90.0785 31.8525 -90.0785C-26.0993 -90.0785 -73.0785 -43.0993 -73.0785 14.8525Z" fill="#607486"/>
        <path d="M255 230.516C255 291.01 205.961 340.049 145.467 340.049C84.9739 340.049 35.9344 291.01 35.9344 230.516C35.9344 170.023 84.9739 120.984 145.467 120.984C205.961 120.984 255 170.023 255 230.516ZM94.2412 230.516C94.2412 258.808 117.176 281.742 145.467 281.742C173.759 281.742 196.693 258.808 196.693 230.516C196.693 202.225 173.759 179.29 145.467 179.29C117.176 179.29 94.2412 202.225 94.2412 230.516Z" fill="#607486"/>
        ...
        <path d="M383.705 191.852C383.705 297.81 297.81 383.705 191.852 383.705C85.8953 383.705 0 297.81 0 191.852C0 85.8953 85.8953 0 191.852 0C297.81 0 383.705 85.8953 383.705 191.852ZM86.9215 191.852C86.9215 249.804 133.901 296.783 191.852 296.783C249.804 296.783 296.783 249.804 296.783 191.852C296.783 133.901 249.804 86.9215 191.852 86.9215C133.901 86.9215 86.9215 133.901 86.9215 191.852Z" fill="#607486"/>
        <circle cx="191.852" cy="191.852" r="66.6721" fill="#F59620"/>
         </svg>

        </div>

        <div className='flex z-40   flex-col w-full py-40 md:p-10 gap-10  bg-transparent  items-center justify-center'>
            ...
            <div className='flex flex-col  w-[80%]  h-full  gap-4'>
                ...
                <div className='flex gap-2'>
                    ...
                    <div className='flex gap-2 justify-center '>
                      ...
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5317 12.4724C15.5208 16.4604 16.4258 11.8467 18.9656 14.3848C21.4143 16.8328 22.8216 17.3232 19.7192 20.4247C19.3306 20.737 16.8616 24.4943 8.1846 15.8197C-0.493478 7.144 3.26158 4.67244 3.57397 4.28395C6.68387 1.17385 7.16586 2.58938 9.61449 5.03733C12.1544 7.5765 7.54266 8.48441 11.5317 12.4724Z" fill="#F59620"/>
                      </svg>
