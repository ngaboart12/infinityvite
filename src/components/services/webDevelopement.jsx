...
function WebDevelopement() {
  return (
    <div className="relative  w-full gap-8  flex flex-col justify-center items-center">
      <h1 className="text-[32px] text-[#F59620] font-[700]">Web Development</h1>
      <div className="flex w-screen flex-col md:flex-row">
        ...
        <div className="flex flex-col w-full mt-4 gap-4 md:mt-0 md:w-1/2 justify-center items-center md:items-start md:justify-start px-4">
          <div className="grid-cols-2 space-x-2 md:grid-cols-4">
